defmodule ExAudit.Tracking do
  ...
  def find_changes(action, struct_or_changeset, resulting_struct) do
    IO.inspect({struct_or_changeset, resulting_struct})
    validity_changes(action, struct_or_changeset, resulting_struct)
  end

  defp validity_changes(action, struct_or_changeset, resulting_struct) do
    old =
